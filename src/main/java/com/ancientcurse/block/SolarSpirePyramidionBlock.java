...
public class SolarSpirePyramidionBlock extends BaseAncientCurseBlock {
    ...
    private void createAssemblyEffects(ServerWorld world, BlockPos centerPos) {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            // Mix of different particle types for dramatic effect
            if (i % 3 == 0) {
                world.spawnParticles(ParticleTypes.END_ROD, x, y, z, 1, 0, 0.1, 0, 0.05);
            } else if (i % 3 == 1) {
        ...
        for (int angle = 0; angle < 360; angle += 15) {
            ...
            world.spawnParticles(ParticleTypes.SOUL_FIRE_FLAME, x, centerPos.getY() + 0.5, z, 
                               2, 0.1, 0.5, 0.1, 0.05);
        }
    }
}