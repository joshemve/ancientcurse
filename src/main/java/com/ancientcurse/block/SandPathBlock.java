...
/**
 * Sand Path Block - A path variant for sand blocks
 * Similar to vanilla dirt path, but for desert environments
 */
public class SandPathBlock extends Block {
    ...
    public BlockState getStateForNeighborUpdate(
        ...
        // If a solid block is placed on top, convert back to sand
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        // Check if path should convert back to sand
