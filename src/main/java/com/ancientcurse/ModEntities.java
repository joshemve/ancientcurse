...
public class ModEntities {
        ...
        public static final EntityType<SnakeHeadProjectileEntity> SNAKE_HEAD_PROJECTILE = Registry.register(
                        ...
                        FabricEntityTypeBuilder
                                        .<SnakeHeadProjectileEntity>create(SpawnGroup.MISC,
                                                        SnakeHeadProjectileEntity::new)
                                        .dimensions(EntityDimensions.fixed(0.5f, 0.5f))
                                        .trackRangeBlocks(64)
                                        .trackedUpdateRate(10) // Update more frequently for smooth movement
                                        .build());
        ...
        public static final EntityType<AnubisEntity> ANUBIS = Registry.register(
                        ...
                        FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, AnubisEntity::new)
                                        .dimensions(EntityDimensions.fixed(2.2f, 4.8f)) // Adjusted to better match the
                                                                                        // ~5 block model
        ...
        public static final EntityType<LocusEntity> LOCUS = Registry.register(
                        ...
                        FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, LocusEntity::new)
                                        .dimensions(EntityDimensions.fixed(0.7f, 0.5f)) // Smaller, more accurate to
                                                                                        // flying insect
                                        .trackRangeBlocks(64)
                                        .trackedUpdateRate(3)
                                        .build());
        ...
        public static final EntityType<ScarabBeetleEntity> SCARAB_BEETLE = Registry.register(
                        ...
                        FabricEntityTypeBuilder.create(SpawnGroup.CREATURE, ScarabBeetleEntity::new)
                                        .dimensions(EntityDimensions.fixed(1.3f, 0.9f)) // Width 1.3 (longer body),
                                                                                        // height 0.9 for easier
                                                                                        // hitting
                                        .trackRangeBlocks(48)
                                        .trackedUpdateRate(3)
                                        .build());
        ...
        public static final EntityType<ThothEntity> THOTH = Registry.register(
                        ...
                        FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ThothEntity::new)
                                        .dimensions(EntityDimensions.fixed(1.8f, 3.5f)) // Larger hitbox for easier
                                                                                        // targeting
                                        .trackRangeBlocks(128) // Large tracking range for boss
                                        .trackedUpdateRate(1) // Frequent updates for smooth boss movement
                                        .build());

        // Register the Khamsin Spread Small entity (Floating mystical rock - Curse
        // system)
        ...
        // Register the Sun Shard projectile
        public static final EntityType<SunShardProjectileEntity> SUN_SHARD_PROJECTILE = Registry.register(
                        Registries.ENTITY_TYPE,
                        new Identifier(AncientCurse.MOD_ID, "sun_shard_projectile"),
                        FabricEntityTypeBuilder
                                        .<SunShardProjectileEntity>create(SpawnGroup.MISC,
                                                        SunShardProjectileEntity::new)
        ...
        public static final EntityType<ZulmakEntity> ZULMAK = Registry.register(
                        ...
                        FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, ZulmakEntity::new)
                                        .dimensions(EntityDimensions.fixed(2.0f, 4.0f)) // Large boss hitbox matching
                                                                                        // model size
                                        .trackRangeBlocks(64)
                                        .trackedUpdateRate(3)
                                        .build());

        // Register the Ra entity (Sun God Boss)
        public static final EntityType<RaEntity> RA = Registry.register(
                        Registries.ENTITY_TYPE,
                        new Identifier(AncientCurse.MOD_ID, "ra"),
                        FabricEntityTypeBuilder.create(SpawnGroup.MONSTER, RaEntity::new)
        ...
        public static void registerEntities() {
                ...
                FabricDefaultAttributeRegistry.register(WITHERED_PHARAOH,
                                WitheredPharaohEntity.createWitheredPharaohAttributes());
                ...
                FabricDefaultAttributeRegistry.register(SCARAB_BEETLE,
                                ScarabBeetleEntity.createScarabBeetleAttributes());
                FabricDefaultAttributeRegistry.register(THOTH, ThothEntity.createThothAttributes());
                FabricDefaultAttributeRegistry.register(KHAMSIN_SPREAD_SMALL,
