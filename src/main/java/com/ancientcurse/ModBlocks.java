...
public class ModBlocks {
        ...
        // Lotus Flower Pad - decorative water plant that opens in day and closes at
        // night
        ...
        // VESSEL_OF_WHISPERING_WINDS moved to
        // com.ancientcurse.block.registry.PotteryBlocks
        // Access it via PotteryBlocks.VESSEL_OF_WHISPERING_WINDS

        // SERPENT_VESSEL_OF_WADJET moved to
        // com.ancientcurse.block.registry.PotteryBlocks
        ...
        // Soulbloom Bush - animated plant that grows on black sand/stone
        public static final Block SOULBLOOM_BUSH = new SoulbloomBushBlock(
        ...
        public static final Block SOLAR_SPIRE = new SolarSpireBlock(
                        FabricBlockSettings.create()
                                        ...
                                        .requiresTool()
                                        .sounds(BlockSoundGroup.STONE)
                                        .luminance(state -> state.get(SolarSpireBlock.ACTIVATED) ? 15 : 7) // Bright
                                                                                                           // when
                                                                                                           // active
        );

        // Desert Plants - Standard desert vegetation
        public static final Block DESERT_SHRUB = new DeadBushBlock(
                        FabricBlockSettings.copyOf(Blocks.DEAD_BUSH).mapColor(MapColor.DARK_GREEN));

        public static final Block DEAD_DESERT_SHRUB = new DeadBushBlock(
                        FabricBlockSettings.copyOf(Blocks.DEAD_BUSH).mapColor(MapColor.BROWN));

        public static final Block DESHRET_BRUSH = new DeadBushBlock(
                        FabricBlockSettings.copyOf(Blocks.DEAD_BUSH).mapColor(MapColor.TERRACOTTA_RED));

        public static final Block DESHRET_THORN_BUSH = new DeadBushBlock(
                        FabricBlockSettings.copyOf(Blocks.DEAD_BUSH).mapColor(MapColor.BLACK));

        public static final Block DESERT_CACTUS_PLANT = new DeadBushBlock(
                        FabricBlockSettings.copyOf(Blocks.DEAD_BUSH).mapColor(MapColor.GREEN));

        public static final Block SEKHEM_CACTUS = new SekhemCactusBlock(
                        FabricBlockSettings.create()
                                        .ticksRandomly()
                                        .mapColor(MapColor.DARK_GREEN)
                                        .strength(0.4F)
        ...
        // NOTE: All cursed plant blocks and Egyptian plant blocks have been moved to
        // their respective registry classes:
        ...
        // This prevents intrusive holders errors by ensuring all blocks are properly
        // registered.
        ...
        public static void registerBlocks() {
                ...
                // REMOVED: Anubus Glyph block was causing registration conflicts
                // Registry.register(Registries.BLOCK, new Identifier(AncientCurse.MOD_ID,
                // "anubus_glyph"), ANUBUS_GLYPH_BLOCK);
                // Registry.register(Registries.ITEM, new Identifier(AncientCurse.MOD_ID,
                // "anubus_glyph"), new BlockItem(...));
                ...
                // OFFERING_POT registration moved to
                // com.ancientcurse.block.registry.PotteryBlocks
                ...
                // POTTERY BLOCKS REGISTRATION MOVED TO
                // com.ancientcurse.block.registry.PotteryBlocks
                ...
                // Register Soulbloom Bush
                Registry.register(
                                Registries.BLOCK,
                                new Identifier(AncientCurse.MOD_ID, "soulbloom_bush"),
                                SOULBLOOM_BUSH);

                // Register Desert Plants
                Registry.register(
                                Registries.BLOCK,
                                new Identifier(AncientCurse.MOD_ID, "desert_shrub"),
                                DESERT_SHRUB);
                Registry.register(
                                Registries.BLOCK,
                                new Identifier(AncientCurse.MOD_ID, "dead_desert_shrub"),
                                DEAD_DESERT_SHRUB);
                Registry.register(
                                Registries.BLOCK,
                                new Identifier(AncientCurse.MOD_ID, "deshret_brush"),
                                DESHRET_BRUSH);
                Registry.register(
                                Registries.BLOCK,
                                new Identifier(AncientCurse.MOD_ID, "deshret_thorn_bush"),
                                DESHRET_THORN_BUSH);
                Registry.register(
                                Registries.BLOCK,
                                new Identifier(AncientCurse.MOD_ID, "desert_cactus_plant"),
                                DESERT_CACTUS_PLANT);
                Registry.register(
                                Registries.BLOCK,
                                new Identifier(AncientCurse.MOD_ID, "sekhem_cactus"),
                                SEKHEM_CACTUS);
                ...
                // Egyptian-themed plant blocks are now registered in EgyptianPlantBlocks
                // registry class
        ...
        private static void registerBlockItems() {
                ...
                // POTTERY BLOCK ITEMS REGISTRATION MOVED TO
                // com.ancientcurse.block.registry.PotteryBlocks
                ...
                registerBlockItem(SOULBLOOM_BUSH, ModItemGroup.ANCIENT_CURSE);

                // Register Desert Plant Items
                registerBlockItem(DESERT_SHRUB, ModItemGroup.ANCIENT_CURSE);
                registerBlockItem(DEAD_DESERT_SHRUB, ModItemGroup.ANCIENT_CURSE);
                registerBlockItem(DESHRET_BRUSH, ModItemGroup.ANCIENT_CURSE);
                registerBlockItem(DESHRET_THORN_BUSH, ModItemGroup.ANCIENT_CURSE);
                registerBlockItem(DESERT_CACTUS_PLANT, ModItemGroup.ANCIENT_CURSE);
                registerBlockItem(SEKHEM_CACTUS, ModItemGroup.ANCIENT_CURSE);
                ...
                // Egyptian-themed plant blocks and cursed plant blocks are now registered in
                // their respective registry classes

                // We don't register a BlockItem for DATE_BLOCK since it should only drop the
                // Sekhem Date item
                // We don't register Anubus Glyph here because it's registered directly in
                // registerBlocks to avoid ID conflicts
        }
        ...
        private static void registerBlockItem(Block block, ItemGroup group) {
                ...
                // Commented out to avoid duplicate registration issues with blocks from other
                // registries
                ...
                if (blockId == null || blockId.equals(new Identifier("minecraft:air"))) {
                        AncientCurse.LOGGER.error(
                                        "Failed to register item for block: " + block.getClass().getSimpleName());
                        return;
                }
        ...
        private static void registerLotusFlowerPadItem() {
                ...
                Registry.register(Registries.ITEM, itemId,
                                new com.ancientcurse.item.LotusFlowerPadItem(LOTUS_FLOWER_PAD,
        ...
        public static void registerFlammableBlocks() {
                ...
                // Cursed wood blocks (can burn but spread less - cursed nature resists fire
                // slightly)
