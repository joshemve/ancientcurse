...
public class SerpentStaffItem extends Item implements GeoItem {
    ...
    public SerpentStaffItem(FabricItemSettings settings) {
    ...
    public void appendTooltip(ItemStack stack, World world, List<Text> tooltip, TooltipContext context) {
        ...
        // Add specific tooltips for the Serpent Staff
        tooltip.add(Text.translatable("item.ancientcurse.serpent_staff.tooltip1").formatted(Formatting.GOLD));
        tooltip.add(Text.translatable("item.ancientcurse.serpent_staff.tooltip2").formatted(Formatting.YELLOW));
        tooltip.add(Text.translatable("item.ancientcurse.serpent_staff.tooltip3").formatted(Formatting.AQUA));
    }
    ...
    private void performTornadoAttack(World world, PlayerEntity player) {
        ...
        if (target instanceof LivingEntity livingTarget) {
            com.ancientcurse.effect.TornadoManager.spawnTornado(world, target.getBlockPos(), livingTarget);
